 ...
 *
 */
package com.jnj.b2b.jnjglobalresources.hmc;
...
/**
 * Provides necessary meta information about the jnjglobalresources hmc extension.
 * 
 * 
 * @version ExtGen v5.5.0.0-M3
 */
public class JnjglobalresourcesHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(JnjglobalresourcesHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.jnj.b2b.jnjglobalresources.hmc.locales";
