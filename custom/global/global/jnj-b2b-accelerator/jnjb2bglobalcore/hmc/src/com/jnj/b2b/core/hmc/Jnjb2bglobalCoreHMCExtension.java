...
/**
 * Provides necessary meta information about the jnjb2bglobalcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class Jnjb2bglobalCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(Jnjb2bglobalCoreHMCExtension.class.getName());
