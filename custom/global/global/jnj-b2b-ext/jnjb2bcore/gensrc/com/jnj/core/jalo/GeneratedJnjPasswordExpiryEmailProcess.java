...
/**
 * Generated class for type {@link de.hybris.platform.commerceservices.jalo.process.StoreFrontCustomerProcess JnjPasswordExpiryEmailProcess}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedJnjPasswordExpiryEmailProcess extends StoreFrontCustomerProcess
{
	/** Qualifier of the <code>JnjPasswordExpiryEmailProcess.securityWindow</code> attribute **/
	public static final String SECURITYWINDOW = "securityWindow";
	/** Qualifier of the <code>JnjPasswordExpiryEmailProcess.logoURL</code> attribute **/
	public static final String LOGOURL = "logoURL";
	/** Qualifier of the <code>JnjPasswordExpiryEmailProcess.portalName</code> attribute **/
	public static final String PORTALNAME = "portalName";
	/** Qualifier of the <code>JnjPasswordExpiryEmailProcess.emailID</code> attribute **/
	public static final String EMAILID = "emailID";
	/** Qualifier of the <code>JnjPasswordExpiryEmailProcess.daysBeforePasswordExpiry</code> attribute **/
	public static final String DAYSBEFOREPASSWORDEXPIRY = "daysBeforePasswordExpiry";
	/** Qualifier of the <code>JnjPasswordExpiryEmailProcess.userFirstName</code> attribute **/
	public static final String USERFIRSTNAME = "userFirstName";
	/** Qualifier of the <code>JnjPasswordExpiryEmailProcess.userLastName</code> attribute **/
	public static final String USERLASTNAME = "userLastName";
	/** Qualifier of the <code>JnjPasswordExpiryEmailProcess.customerName</code> attribute **/
	public static final String CUSTOMERNAME = "customerName";
	/** Qualifier of the <code>JnjPasswordExpiryEmailProcess.userRoles</code> attribute **/
	public static final String USERROLES = "userRoles";
	/** Qualifier of the <code>JnjPasswordExpiryEmailProcess.emailNotifications</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>JnjPasswordExpiryEmailProcess.customerName</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>JnjPasswordExpiryEmailProcess.customerName</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>JnjPasswordExpiryEmailProcess.daysBeforePasswordExpiry</code> attribute.
	 * @return the daysBeforePasswordExpiry - Attribute contains number of days before the password is being expired.
	 */
	public Integer getDaysBeforePasswordExpiry(final SessionContext ctx)
	{
		return (Integer)getProperty( ctx, DAYSBEFOREPASSWORDEXPIRY);
	}
	 ...
	 * @return the daysBeforePasswordExpiry - Attribute contains number of days before the password is being expired.
	 */
	public int getDaysBeforePasswordExpiryAsPrimitive(final SessionContext ctx)
	{
		Integer value = getDaysBeforePasswordExpiry( ctx );
	 ...
	 * @return the daysBeforePasswordExpiry - Attribute contains number of days before the password is being expired.
	 */
	public int getDaysBeforePasswordExpiryAsPrimitive()
	{
		return getDaysBeforePasswordExpiryAsPrimitive( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>JnjPasswordExpiryEmailProcess.daysBeforePasswordExpiry</code> attribute. 
	 * @param value the daysBeforePasswordExpiry - Attribute contains number of days before the password is being expired.
	 */
	public void setDaysBeforePasswordExpiry(final SessionContext ctx, final Integer value)
	{
	 ...
	 * @param value the daysBeforePasswordExpiry - Attribute contains number of days before the password is being expired.
	 */
	public void setDaysBeforePasswordExpiry(final Integer value)
	{
	 ...
	 * @param value the daysBeforePasswordExpiry - Attribute contains number of days before the password is being expired.
	 */
	public void setDaysBeforePasswordExpiry(final SessionContext ctx, final int value)
	{
		setDaysBeforePasswordExpiry( ctx,Integer.valueOf( value ) );
	}
	 ...
	 * @param value the daysBeforePasswordExpiry - Attribute contains number of days before the password is being expired.
	 */
	public void setDaysBeforePasswordExpiry(final int value)
	{
		setDaysBeforePasswordExpiry( getSession().getSessionContext(), value );
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>JnjPasswordExpiryEmailProcess.emailID</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>JnjPasswordExpiryEmailProcess.emailID</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>JnjPasswordExpiryEmailProcess.emailNotifications</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>JnjPasswordExpiryEmailProcess.emailNotifications</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>JnjPasswordExpiryEmailProcess.logoURL</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>JnjPasswordExpiryEmailProcess.logoURL</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>JnjPasswordExpiryEmailProcess.portalName</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>JnjPasswordExpiryEmailProcess.portalName</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>JnjPasswordExpiryEmailProcess.securityWindow</code> attribute.
	 * @return the securityWindow - Attribute contains security window for the password expiry.
	 */
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>JnjPasswordExpiryEmailProcess.securityWindow</code> attribute. 
	 * @param value the securityWindow - Attribute contains security window for the password expiry.
	 */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>JnjPasswordExpiryEmailProcess.userFirstName</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>JnjPasswordExpiryEmailProcess.userFirstName</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>JnjPasswordExpiryEmailProcess.userLastName</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>JnjPasswordExpiryEmailProcess.userLastName</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>JnjPasswordExpiryEmailProcess.userRoles</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>JnjPasswordExpiryEmailProcess.userRoles</code> attribute. 
